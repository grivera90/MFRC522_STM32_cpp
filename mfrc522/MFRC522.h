...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522();
	MFRC522(GPIO_TypeDef *resetPowerDownPort, uint16_t resetPowerDownPin);
	MFRC522(GPIO_TypeDef *chipSelectPort, uint16_t chipSelectPin, GPIO_TypeDef *resetPowerDownPort, uint16_t resetPowerDownPin);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	void PCD_Init();
	void PCD_Init(GPIO_TypeDef * resetPowerDownPort, uint16_t resetPowerDownPin);
	void PCD_Init(GPIO_TypeDef * chipSelectPort, uint16_t chipSelectPin, GPIO_TypeDef * resetPowerDownPort, uint16_t resetPowerDownPin);
	void PCD_Reset();
	void PCD_AntennaOn();
	void PCD_AntennaOff();
...
protected:
	...
	GPIO_TypeDef *_chipSelectPort;		// Arduino port connected to MFRC522's SPI slave select input (Pin 24, NSS, active low)
	uint16_t _resetPowerDownPin;	// Arduino pin connected to MFRC522's reset and power down input (Pin 6, NRSTPD, active low)
	GPIO_TypeDef *_resetPowerDownPort;	// Arduino port connected to MFRC522's reset and power down input (Pin 6, NRSTPD, active low)
